...
public class PlatformController : RaycastController {
	...
	Vector3 CalculatePlatformMovement() {
		...
		float distanceBetewwnWaypoints = Vector3.Distance(globalWaypoints[fromWaypointIndex], globalWaypoints[toWaypointIndex]);
		percentBetweenWaypoints += Time.deltaTime * speed/distanceBetewwnWaypoints;
